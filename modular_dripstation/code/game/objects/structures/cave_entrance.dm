...
/obj/effect/collapsing_demonic_portal/proc/drop_loot()
	...
	switch(loot)
		...
		if(5)//syndicate incursion. Again, high-quality loot at low chances, this time with excessive levels of danger
			...
			if(prob(65))
				if(prob(85))
					new /obj/item/clothing/suit/space/hardsuit/dualmode(loc)
					new /mob/living/simple_animal/hostile/syndicate/ranged/smg/space(loc)
				else
					if(prob(50))
						new /obj/item/clothing/suit/space/hardsuit/dualmode/engineering/syndicate/winter(loc)
						new /mob/living/simple_animal/hostile/syndicate/melee/sword/space/stormtrooper(loc)
					else
						new /obj/item/clothing/suit/space/hardsuit/dualmode/bloodred/winter(loc)
			...
			if(prob(15))
				new /obj/item/clothing/under/syndicate/waffle/cargo(loc)
				new /obj/item/clothing/head/hardhat/orange(loc)
				new /obj/item/gun/ballistic/automatic/c20r/cobra/nopin(loc)
			if(prob(35))
			...
			if(prob(35))
				...
				new /obj/item/clothing/under/syndicate/cybersun(loc)
			...
			if(prob(35))
				...
				new /mob/living/simple_animal/hostile/syndicate/melee/sword/icemoon(loc)
			if(prob(20))
				new /obj/item/book/granter/crafting_recipe/weapons(loc)
				new /mob/living/simple_animal/hostile/syndicate/ranged/shotgun/icemoon(loc)
			if(prob(5))
				new /obj/item/melee/transforming/energy/sword/saber(loc)
				new /mob/living/simple_animal/hostile/syndicate/ranged/shotgun/space/stormtrooper(loc)
			if(prob(5))
		...
		if(18)//xenobiologist's hubris
			...
			new /obj/item/research_notes(loc, pick(1000, 2000, 3000, 4000), TECHWEB_POINT_TYPE_MEDICAL, "xenobiology")

...
/obj/structure/sign/poster/traitor/attackby(obj/item/tool, mob/user, params)
	if (istype(tool) && tool.tool_behaviour == TOOL_WIRECUTTER)
...
/obj/structure/sign/poster/traitor/small_brain
	...
	desc = "Statistics on this poster indicate that the IQ of Nanotrasen employees are on average 20% smaller than normal human beeng."
...
/obj/structure/sign/poster/traitor/low_pay
	...
	desc = "This poster displays a comparison of Nanotrasen standard wages to common luxury items. If this is accurate, it takes upwards of 30,000 seconds of work just to buy a simple bicycle."

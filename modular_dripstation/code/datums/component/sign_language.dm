...
/datum/component/sign_language/proc/enable_sign_language()
	...
	var/obj/item/organ/tongue/tongue = carbon_parent.getorganslot(ORGAN_SLOT_TONGUE)
	if(tongue)
	...
	carbon_parent.verb_ask = "interrogative signs"
	carbon_parent.verb_exclaim = "intensively signs"
...
/datum/component/sign_language/proc/on_say(mob/living/carbon/carbon_parent, list/speech_args)
	...
	if(question_found)
		tonal_indicator = mutable_appearance('modular_dripstation/icons/mob/talk.dmi', "signlang1", TYPING_LAYER)
		//carbon_parent.bubble_type = "signlang1"
		carbon_parent.visible_message(span_notice("[carbon_parent] lowers [carbon_parent.p_their()] eyebrows."))
	else if(exclamation_found)
		//carbon_parent.bubble_type = "signlang2"
		tonal_indicator = mutable_appearance('modular_dripstation/icons/mob/talk.dmi', "signlang2", TYPING_LAYER)

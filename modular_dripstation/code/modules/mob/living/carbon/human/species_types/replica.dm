...
/datum/species/replica
	...
	inherent_traits = list(TRAIT_RADIMMUNE, TRAIT_LIMBATTACHMENT, TRAIT_EASYDISMEMBER, TRAIT_NOCRITDAMAGE, TRAIT_NOSOFTCRIT, TRAIT_GENELESS, TRAIT_MEDICALIGNORE, TRAIT_NOCLONE, TRAIT_NO_BLOOD_REGEN, TRAIT_POWERHUNGRY, TRAIT_REDUCED_DAMAGE_SLOWDOWN, TRAIT_NO_PAIN_EMOTE, TRAIT_NO_NORMAL_FEAR, TRAIT_NO_ABNORMAL_FEAR)

...
/datum/controller/subsystem/traumas/Initialize()
	...
	phobia_objs = list("snakes" = typecacheof(list(/obj/item/rod_of_asclepius)),
				   ...
				   "conspiracies" = typecacheof(list(/obj/item/clothing/under/rank/command/captain, /obj/item/clothing/under/rank/security/head_of_security,
					   ...
					   "anime" = typecacheof(list(/obj/item/clothing/under/costume/schoolgirl, /obj/item/melee/katana, /obj/item/reagent_containers/food/snacks/sashimi, /obj/item/reagent_containers/food/snacks/chawanmushi,

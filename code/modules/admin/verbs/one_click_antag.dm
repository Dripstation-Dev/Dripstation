...
/datum/admins/proc/one_click_antag()
	...
	var/dat = {"
		...
		<a href='byond://?src=[REF(src)];[HrefToken()];makeAntag=heretics'>Make Heretics</a><br>
		...
		<a href='byond://?src=[REF(src)];[HrefToken()];makeAntag=darkspawn'>Make Darkspawn</a><br>
		<a href='byond://?src=[REF(src)];[HrefToken()];makeAntag=vampire'>Make Vampire</a><br>
		<a href='byond://?src=[REF(src)];[HrefToken()];makeAntag=infiltrator'>Make Infiltration Team (Requires Ghosts)</a>
		"}

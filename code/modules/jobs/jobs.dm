...
/proc/get_full_job_name(job)
	...
	// yogs end
	//dripstation start
	var/static/regex/bs_expand = new("бш")
	var/static/regex/ntr_expand = new("нтр")
	var/static/regex/mag_expand = new("мага")
	...
	// yogs end
	//dripstation start
	job = bs_expand.Replace(job, "синий щит")
	job = ntr_expand.Replace(job, "представитель нанотрейзен")
	job = mag_expand.Replace(job, "магистрат")

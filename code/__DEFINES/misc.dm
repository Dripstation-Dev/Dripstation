...
#define HANDS_SPRITE_LAYER		20	//I need this for literally one sprite accessory
...
#define FACEMASK_LAYER			5
#define HEAD_LAYER				4
#define SIDE_HEAD_LAYER			3		//because i want freels over helmet

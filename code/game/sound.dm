...
/proc/get_sfx(soundin)
	if(istext(soundin))
		switch(soundin)
			...
			if(SFX_SLICE)
				soundin = pick('modular_dripstation/sound/weapons/slice.ogg', 'modular_dripstation/sound/weapons/slice2.ogg', 'modular_dripstation/sound/weapons/slice3.ogg', 'modular_dripstation/sound/weapons/slice4.ogg', 'modular_dripstation/sound/weapons/slice5.ogg', 'modular_dripstation/sound/weapons/slice6.ogg', 'modular_dripstation/sound/weapons/slice7.ogg')
			if(SFX_SLASH)
			...
			if(SFX_KATANA_SWING)
				soundin = pick('modular_dripstation/sound/weapons/Katana_Fire_1.wav', 'modular_dripstation/sound/weapons/Katana_Fire_2.wav', 'modular_dripstation/sound/weapons/Katana_Fire_3.wav', 'modular_dripstation/sound/weapons/Katana_Fire_4.wav')
			if(SFX_SWING_HIT)

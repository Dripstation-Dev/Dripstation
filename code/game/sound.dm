...
/proc/get_sfx(soundin)
	if(istext(soundin))
		switch(soundin)
			...
			if(SFX_SLASHMISS)
				soundin = pick('modular_dripstation/sound/weapons/slash_1.wav', 'modular_dripstation/sound/weapons/slash_2.wav', 'modular_dripstation/sound/weapons/slash_3.wav', 'modular_dripstation/sound/weapons/slash_4.wav')
			if(SFX_KATANA_SWING)

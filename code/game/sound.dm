...
/proc/get_sfx(soundin)
	if(istext(soundin))
		switch(soundin)
			...
			if(SFX_SLICE)
				soundin = pick('modular_dripstation/sound/weapons/slice.ogg', 'modular_dripstation/sound/weapons/slice2.ogg', 'modular_dripstation/sound/weapons/slice3.ogg', 'modular_dripstation/sound/weapons/slice4.ogg', 'modular_dripstation/sound/weapons/slice5.ogg', 'modular_dripstation/sound/weapons/slice6.ogg')
			if(SFX_SLASH)
				soundin = pick('modular_dripstation/sound/weapons/slash_1.wav', 'modular_dripstation/sound/weapons/slash_2.wav', 'modular_dripstation/sound/weapons/slash_3.wav')
			if(SFX_CLAWS)
				soundin = pick('modular_dripstation/sound/weapons/claws_1.wav', 'modular_dripstation/sound/weapons/claws_2.wav', 'modular_dripstation/sound/weapons/claws_3.wav')
			if(SFX_ETHERIALPUNCH)
				soundin = pick('sound/weapons/etherealhit.ogg')
			if(SFX_GENERICMISS)
				soundin = pick('sound/weapons/punchmiss.ogg')
			if(SFX_ETHERIALMISS)
				soundin = pick('sound/weapons/etherealmiss.ogg')
			if(SFX_SLASHMISS)
				soundin = pick('modular_dripstation/sound/weapons/slashmiss_1.wav', 'modular_dripstation/sound/weapons/slashmiss_2.wav', 'modular_dripstation/sound/weapons/slashmiss_3.wav', 'modular_dripstation/sound/weapons/slashmiss_4.wav')
			if(SFX_KATANA_SWING)
				soundin = pick('modular_dripstation/sound/weapons/katana_hit_1.ogg', 'modular_dripstation/sound/weapons/katana_hit_2.ogg', 'modular_dripstation/sound/weapons/katana_hit_3.ogg', 'modular_dripstation/sound/weapons/katana_hit_4.ogg', 'modular_dripstation/sound/weapons/katana_hit_5.ogg', 'modular_dripstation/sound/weapons/katana_hit_6.ogg')
			if(SFX_SWORD_SWING)
				soundin = pick('modular_dripstation/sound/weapons/sword_hit_1.ogg', 'modular_dripstation/sound/weapons/sword_hit_2.ogg', 'modular_dripstation/sound/weapons/sword_hit_3.ogg')
			if(SFX_PUNCH)
				soundin = pick('modular_dripstation/sound/weapons/blunt_punch1.ogg','modular_dripstation/sound/weapons/blunt_punch2.ogg','modular_dripstation/sound/weapons/blunt_punch3.ogg')
			if(SFX_BLUNT)
				soundin = pick('modular_dripstation/sound/weapons/blunt1.ogg','modular_dripstation/sound/weapons/blunt2.ogg','modular_dripstation/sound/weapons/blunt3.ogg')
			if(SFX_PIERCE)
				soundin = pick('modular_dripstation/sound/weapons/pierce1.ogg')
			if(SFX_STAB)
				soundin = pick('modular_dripstation/sound/weapons/stab1.wav', 'modular_dripstation/sound/weapons/stab2.wav', 'modular_dripstation/sound/weapons/stab3.wav', 'modular_dripstation/sound/weapons/stab4.wav')
			if(SFX_EVADE)
				soundin = pick('modular_dripstation/sound/weapons/block/evade.ogg')
			if(SFX_COMBAT_KNIFE)
				soundin = pick('modular_dripstation/sound/weapons/combat_knife1.ogg', 'modular_dripstation/sound/weapons/combat_knife2.ogg')
			if(SFX_FELINE_HISS)
				soundin = pick('sound/voice/feline/hiss1.ogg', 'sound/voice/feline/hiss2.ogg', 'sound/voice/feline/hiss3.ogg')
			if(SFX_VENDING_SHAKE)
				soundin = pick('modular_dripstation/sound/machines/vending_shake_1.wav', 'modular_dripstation/sound/machines/vending_shake_2.wav')
